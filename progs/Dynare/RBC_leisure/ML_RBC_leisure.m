...
M_.endo_names_long = char(M_.endo_names_long, 'output growth');
...
erase_compiled_function('ML_RBC_leisure_static');
erase_compiled_function('ML_RBC_leisure_dynamic');
M_.orig_eq_nbr = 9;
M_.eq_nbr = 9;
M_.ramsey_eq_nbr = 0;
...
estim_params_.param_vals = [estim_params_.param_vals; 1, 0.33, 0.01, 0.9900, 0, NaN, NaN, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 6, 0.90, 0.50, 0.9999, 0, NaN, NaN, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 1, 0.50, 0.01, 1.0000, 0, NaN, NaN, NaN, NaN, NaN ];
steady;
resid;  
...
save('ML_RBC_leisure_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('ML_RBC_leisure_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('ML_RBC_leisure_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('ML_RBC_leisure_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('ML_RBC_leisure_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('ML_RBC_leisure_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('ML_RBC_leisure_results.mat', 'oo_recursive_', '-append');
end
