...
diary off;
diary('Bayesian_RBC_leisure.log');
M_.exo_names = 'eps_A';
...
erase_compiled_function('Bayesian_RBC_leisure_static');
erase_compiled_function('Bayesian_RBC_leisure_dynamic');
M_.orig_eq_nbr = 9;
M_.eq_nbr = 9;
M_.ramsey_eq_nbr = 0;
...
estim_params_.var_exo = [estim_params_.var_exo; 1, NaN, (-Inf), Inf, 4, 0.5, 4, 0.0001, 5, NaN ];
steady;
resid;  
...
options_.mode_compute = 4;
options_.datafile = 'simdat.mat';
options_.mode_file = 'Bayesian_RBC_leisure_mode';
options_.first_obs = 1;
options_.nobs = 200;
options_.order = 1;
var_list_ = char('dy');
...
CPUnbr = 2                                  
save('Bayesian_RBC_leisure_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Bayesian_RBC_leisure_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Bayesian_RBC_leisure_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Bayesian_RBC_leisure_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Bayesian_RBC_leisure_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('Bayesian_RBC_leisure_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('Bayesian_RBC_leisure_results.mat', 'oo_recursive_', '-append');
end
