...
M_.endo_names = char(M_.endo_names, 'AUX_ENDO_LEAD_21');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_ENDO\_LEAD\_21');
M_.endo_names_long = char(M_.endo_names_long, 'AUX_ENDO_LEAD_21');
...
erase_compiled_function('RBC_habit_static');
erase_compiled_function('RBC_habit_dynamic');
M_.orig_eq_nbr = 8;
M_.eq_nbr = 9;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state(9)=1/(oo_.steady_state(2)-oo_.steady_state(2)*M_.params(6));
if M_.exo_nbr > 0
...
save('RBC_habit_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('RBC_habit_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('RBC_habit_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('RBC_habit_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('RBC_habit_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('RBC_habit_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('RBC_habit_results.mat', 'oo_recursive_', '-append');
end
