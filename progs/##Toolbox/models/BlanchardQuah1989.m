function [ENDO,EXOG,opt] = BlanchardQuah1989(opt)
% =======================================================================
% Replication of the structural VAR in Blanchard and Quah (1989, AER)
% =======================================================================
...
opt.Rshorth = {};
% Aggregate demand shock has no long-run effect on the level or real GDP
opt.Rlong  =  [nan 0;
               nan nan;
              ];
opt.Rsign  =  [nan nan;
